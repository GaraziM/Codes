...
parent_dir = '2_Reads/4_Host_removed/AH1_1st_1_a"'
...
rule Coassembly:
    input:
        reads = "2_Reads/4_Host_removed/AH1_1st_1_a/{group}"
    output:
    ...
    shell:
        ...
        R1=$(for i in 2_Reads/4_Host_removed/AH1_1st_1_a/{wildcards.group}/*_1.fq.gz; do echo $i | tr '\n' ,; done)
        R2=$(for i in 2_Reads/4_Host_removed/AH1_1st_1_a/{wildcards.group}/*_2.fq.gz; do echo $i | tr '\n' ,; done)
...
rule Coassembly_mapping:
    ...
    params:
        r1 = "2_Reads/4_Host_removed/AH1_1st_1_a/{group}/{sample}_M_1.fq.gz",
        r2 = "2_Reads/4_Host_removed/AH1_1st_1_a/{group}/{sample}_M_2.fq.gz",
